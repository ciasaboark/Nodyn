 ...
 * Use the {@link AssetHistoryFragment#newInstance} factory method to
...
public class AssetHistoryFragment extends Fragment {
    ...
    public static AssetHistoryFragment newInstance(Asset asset) {
        AssetHistoryFragment fragment = new AssetHistoryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_asset_history, container, false);
    ...
    private void init() {
        ...
        try {
            List<AssetHistoryRecord> historyRecords = tryPullAssetHistoryRecords();
    ...
    private
    @NotNull
    List<AssetHistoryRecord> tryPullAssetHistoryRecords() throws SyncNotSupportedException, SyncException {
        SyncAdapter adapter = SyncManager.getPrefferedSyncAdapter(getActivity());
        return adapter.getHistory(getActivity(), asset);
    }
