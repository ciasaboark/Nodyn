...
public class SyncNotificationFragment extends Fragment {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action) {
                    ...
                    case SyncService.BROADCAST_SYNC_UPDATE:
                        ...
                        int progress = intent.getIntExtra(SyncService.BROADCAST_SYNC_PROGRESS, -1);

                        if (progress == -1) {
                            showActiveMessage("Sync in progress", updateMessage);
                        } else {
                            showActiveMessage("Sync in progress", updateMessage, progress);
                        }
                }
            }
        };
    ...
    private void showActiveMessage(@NotNull String msg, @Nullable String err) {
        showActiveMessage(msg, err, null);
    }

    private void showActiveMessage(@NotNull String msg, @Nullable String err, @Nullable Integer progress) {
