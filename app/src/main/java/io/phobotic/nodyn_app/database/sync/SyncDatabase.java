...
@Database(entities = {SyncAttempt.class, SyncedAction.class}, version = 4, exportSchema = false)
public abstract class SyncDatabase extends RoomDatabase {
    ...
    public abstract SyncAttemptDao syncAttemptDao();
    public abstract SyncedActionDao syncedActionDao();
}