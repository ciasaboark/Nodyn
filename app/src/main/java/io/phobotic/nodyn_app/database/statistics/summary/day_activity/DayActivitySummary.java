...
public class DayActivitySummary {
    ...
    @Ignore
    public DayActivitySummary() {
    }

    public DayActivitySummary(long timestamp, int totalCheckouts, int totalCheckins, int totalAudits) {
    ...
    public DayActivitySummary setTimestamp(long timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public DayActivitySummary setTotalCheckouts(int totalCheckouts) {
        this.totalCheckouts = totalCheckouts;
        return this;
    }
    ...
    public DayActivitySummary setTotalCheckins(int totalCheckins) {
        this.totalCheckins = totalCheckins;
        return this;
    }
