...
public class PreferenceSectionView extends LinearLayout {
    ...
    public PreferenceSectionView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        rootView.setOnClickListener(l);
    ...
    public void setHighlighted(boolean highlighted) {
        ...
        if (highlighted != this.highlighted) {
            @ColorInt int startColor = getResources().getColor(R.color.white);;
            @ColorInt int endColor;

            if (highlighted) {
                showBackArrow();
                endColor = getContext().getResources().getColor(R.color.default_accent);
            } else {
                hideBackArrow();
                //swap the start and end colors
                endColor = startColor;
                startColor = getContext().getResources().getColor(R.color.default_accent);
            }
