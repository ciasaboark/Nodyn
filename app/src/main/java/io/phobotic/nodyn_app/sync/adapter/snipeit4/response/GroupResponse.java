...
public class GroupResponse {
    private int total;
    @SerializedName("rows")
    private List<Snipeit4Group> groups;

    public int getTotal() {
        return total;
    }

    public GroupResponse setTotal(int total) {
        this.total = total;
        return this;
    }

    public List<Snipeit4Group> getGroups() {
        return groups;
    }

    public GroupResponse setGroups(List<Snipeit4Group> groups) {
        this.groups = groups;
        return this;
    }
}
